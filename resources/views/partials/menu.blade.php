<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('product_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/categories*") ? "c-show" : "" }} {{ request()->is("admin/colors*") ? "c-show" : "" }} {{ request()->is("admin/special-fors*") ? "c-show" : "" }} {{ request()->is("admin/locations*") ? "c-show" : "" }} {{ request()->is("admin/items*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('special_for_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.special-fors.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/special-fors") || request()->is("admin/special-fors/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-male c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.specialFor.title') }}
                            </a>
                        </li>
                    @endcan
                    @can('location_access')
